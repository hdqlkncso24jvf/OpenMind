...
![Exp](https://github.com/hdqlkncso24jvf/OpenMind/blob/main/OpenMind.png)

* The **full version** of the paper can be accessed at this file: [`OpenMind_full_version.pdf`](https://github.com/hdqlkncso24jvf/OpenMind/blob/main/OpenMind_full_version.pdf)
