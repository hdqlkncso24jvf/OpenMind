#ifndef EXAMPLES_ANALYTICAL_APPS_PROB_GAR_MATCH_H_
#define EXAMPLES_ANALYTICAL_APPS_PROB_GAR_MATCH_H_
...
#include "flags.h"
#include "prob_gar_chase/prob_gar_chase.h"
#include "timer.h"
...
void Run() {
  ...
  using AppType = ProbGarChase<GraphType>;
...
#endif  // EXAMPLES_ANALYTICAL_APPS_PROB_GAR_MATCH_H_
