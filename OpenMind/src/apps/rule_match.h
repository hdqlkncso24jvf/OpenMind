#ifndef EXAMPLES_ANALYTICAL_APPS_RULE_MATCH_H_
#define EXAMPLES_ANALYTICAL_APPS_RULE_MATCH_H_
...
#include "flags.h"
#include "rule_match/rule_match.h"
#include "timer.h"
...
void Run() {
  ...
  using AppType = RuleMatch<GraphType>;
...
#endif  // EXAMPLES_ANALYTICAL_APPS_RULE_MATCH_H_
