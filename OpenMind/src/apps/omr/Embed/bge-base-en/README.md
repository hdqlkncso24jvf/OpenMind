...
model_dir = snapshot_download("AI-ModelScope/bge-base-en-v1.5", revision='master')
...
tokenizer = AutoTokenizer.from_pretrained('AI-ModelScope/bge-base-en-v1.5')
model = AutoModel.from_pretrained('AI-ModelScope/bge-base-en-v1.5')
model.eval()
