...
def load_omr_models(graph, ml_cache=None, dis_edge_label: str='has_tag', aggr_edge_label: str='plays', dis_fallback: str='rwr'):
    ...
    dis_model = DisModel(graph, edge_label=dis_edge_label, interaction_edge_label=aggr_edge_label, ml_cache=ml_cache, fallback_mode=dis_fallback)
