#ifndef EXAMPLES_ANALYTICAL_APPS_SUPPORT_SAMPLE_SUPPORT_SAMPLE_CONTEXT_H_
#define EXAMPLES_ANALYTICAL_APPS_SUPPORT_SAMPLE_SUPPORT_SAMPLE_CONTEXT_H_
...
/**
 * @brief Context for the parallel version of SupportSample.
 *
 * @tparam FRAG_T
 */
template <typename FRAG_T>
class SupportSampleContext : public VertexDataContext<FRAG_T, int64_t> {
 public:
  using oid_t = typename FRAG_T::oid_t;
  using vid_t = typename FRAG_T::vid_t;

  explicit SupportSampleContext(const FRAG_T& fragment)
  ...
  using Pattern   = GUNDAM::LargeGraph<VertexIDType, VertexLabelType, VertexAttributeKeyType,
                                         EdgeIDType,   EdgeLabelType,   EdgeAttributeKeyType>;
  using DataGraph = GUNDAM::LargeGraph<VertexIDType, VertexLabelType, VertexAttributeKeyType,
                                         EdgeIDType,   EdgeLabelType,   EdgeAttributeKeyType>;
  ...
  using GARPatternToPattern
      = gar::GraphAssociationRule<Pattern, Pattern>;
...
#endif  // EXAMPLES_ANALYTICAL_APPS_SUPPORT_SAMPLE_SUPPORT_SAMPLE_CONTEXT_H_
