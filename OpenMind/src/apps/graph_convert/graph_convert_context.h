#ifndef EXAMPLES_ANALYTICAL_APPS_GRAPH_CONVERT_GRAPH_CONVERT_CONTEXT_H_
#define EXAMPLES_ANALYTICAL_APPS_GRAPH_CONVERT_GRAPH_CONVERT_CONTEXT_H_
...
/**
 * @brief Context for the parallel version of GraphConvert.
 *
 * @tparam FRAG_T
 */
template <typename FRAG_T>
class GraphConvertContext : public VertexDataContext<FRAG_T, int64_t> {
 public:
  using oid_t = typename FRAG_T::oid_t;
  using vid_t = typename FRAG_T::vid_t;

  explicit GraphConvertContext(const FRAG_T& fragment)
...
#endif  // EXAMPLES_ANALYTICAL_APPS_GRAPH_CONVERT_GRAPH_CONVERT_CONTEXT_H_
