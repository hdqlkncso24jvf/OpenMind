#ifndef EXAMPLES_ANALYTICAL_APPS_GCR_DISCOVER_H_
#define EXAMPLES_ANALYTICAL_APPS_GCR_DISCOVER_H_
...
#include "flags.h"
#include "rule_discover/gcr_discover.h"
#include "timer.h"
...
void Run() {
  ...
  using AppType = GcrDiscover<GraphType>;
...
#endif  // EXAMPLES_ANALYTICAL_APPS_GCR_DISCOVER_H_
