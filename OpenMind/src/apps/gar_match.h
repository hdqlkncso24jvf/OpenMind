#ifndef EXAMPLES_ANALYTICAL_APPS_GAR_MATCH_H_
#define EXAMPLES_ANALYTICAL_APPS_GAR_MATCH_H_
...
void Run() {
  ...
  using AppType = GarMatch<GraphType>;
...
#endif  // EXAMPLES_ANALYTICAL_APPS_GAR_MATCH_H_
