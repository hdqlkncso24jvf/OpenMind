#ifndef EXAMPLES_ANALYTICAL_APPS_DISCOVERED_GFD_ANALYSIS_DISCOVERED_GFD_ANALYSIS_CONTEXT_H_
#define EXAMPLES_ANALYTICAL_APPS_DISCOVERED_GFD_ANALYSIS_DISCOVERED_GFD_ANALYSIS_CONTEXT_H_
...
/**
 * @brief Context for the parallel version of DiscoveredGfdAnalysis.
 *
 * @tparam FRAG_T
 */
template <typename FRAG_T>
class DiscoveredGfdAnalysisContext : public VertexDataContext<FRAG_T, int64_t> {
 public:
  using oid_t = typename FRAG_T::oid_t;
  using vid_t = typename FRAG_T::vid_t;

  explicit DiscoveredGfdAnalysisContext(const FRAG_T& fragment)
  ...
  using VertexPtrType = typename GUNDAM::VertexHandle<Pattern>::type;
...
#endif  // EXAMPLES_ANALYTICAL_APPS_DISCOVERED_GFD_ANALYSIS_DISCOVERED_GFD_ANALYSIS_CONTEXT_H_
