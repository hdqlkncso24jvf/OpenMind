#ifndef EXAMPLES_ANALYTICAL_APPS_GAR_OVERLAP_GAR_OVERLAP_CONTEXT_H_
#define EXAMPLES_ANALYTICAL_APPS_GAR_OVERLAP_GAR_OVERLAP_CONTEXT_H_
...
namespace grape {
/**
 * @brief Context for the parallel version of GarOverlap.
 *
 * @tparam FRAG_T
 */
template <typename FRAG_T>
class GarOverlapContext : public VertexDataContext<FRAG_T, int64_t> {
 public:
  using oid_t = typename FRAG_T::oid_t;
  using vid_t = typename FRAG_T::vid_t;

  explicit GarOverlapContext(const FRAG_T& fragment)
...
#endif  // EXAMPLES_ANALYTICAL_APPS_GAR_OVERLAP_GAR_OVERLAP_CONTEXT_H_
