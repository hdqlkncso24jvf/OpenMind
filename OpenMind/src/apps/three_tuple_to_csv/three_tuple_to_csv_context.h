#ifndef EXAMPLES_ANALYTICAL_APPS_THREE_TUPLE_TO_CSV_THREE_TUPLE_TO_CSV_CONTEXT_H_
#define EXAMPLES_ANALYTICAL_APPS_THREE_TUPLE_TO_CSV_THREE_TUPLE_TO_CSV_CONTEXT_H_
...
/**
 * @brief Context for the parallel version of ThreeTupleToCsv.
 *
 * @tparam FRAG_T
 */
template <typename FRAG_T>
class ThreeTupleToCsvContext : public VertexDataContext<FRAG_T, int64_t> {
 public:
  using oid_t = typename FRAG_T::oid_t;
  using vid_t = typename FRAG_T::vid_t;

  explicit ThreeTupleToCsvContext(const FRAG_T& fragment)
  ...
  static constexpr std::string_view kPatternPosfix = "_v.csv";
...
#endif  // EXAMPLES_ANALYTICAL_APPS_THREE_TUPLE_TO_CSV_THREE_TUPLE_TO_CSV_CONTEXT_H_
