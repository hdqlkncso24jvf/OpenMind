#ifndef EXAMPLES_ANALYTICAL_APPS_PATTERN_EXIST_PATTERN_EXIST_CONTEXT_H_
#define EXAMPLES_ANALYTICAL_APPS_PATTERN_EXIST_PATTERN_EXIST_CONTEXT_H_
...
/**
 * @brief Context for the parallel version of PatternExist.
 *
 * @tparam FRAG_T
 */
template <typename FRAG_T>
class PatternExistContext : public VertexDataContext<FRAG_T, int64_t> {
 public:
  using oid_t = typename FRAG_T::oid_t;
  using vid_t = typename FRAG_T::vid_t;

  explicit PatternExistContext(const FRAG_T& fragment)
...
#endif  // EXAMPLES_ANALYTICAL_APPS_PATTERN_EXIST_PATTERN_EXIST_CONTEXT_H_
