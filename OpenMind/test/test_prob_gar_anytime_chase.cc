...
#include "include/prob_gar/prob_gar_anytime_chase.h"
...
int main() {
  ...
  using GraphPatternType = GUNDAM::SmallGraph<int, char,
                                              int, char>;
  // using GraphPatternType = GUNDAM::LargeGraph<int, char, std::string,
  //                                             int, char, std::string>;
  ...
  prob_gar::ProbGARAnytimeChase(prob_gar_0, 
                              data_graph_0, 
                               diff_edge_0);
  ...
  prob_gar::ProbGARAnytimeChase(prob_gar_set_1, 
                                  data_graph_1, 
                                   diff_edge_1);
  ...
  prob_gar::ProbGARAnytimeChase(prob_gar_set_2, 
                                  data_graph_2, 
                                   diff_edge_2);
  ...
  prob_gar::ProbGARAnytimeChase(prob_gar_set_3, 
                                  data_graph_3, 
                                   diff_edge_3);
