...
namespace her
{
    ...
    DEFINE_string(g_updated_efile, "", "updated G file");
    DEFINE_string(gd_updated_efile, "", "updated GD file");
    DEFINE_string(delta_g, "", "Delta G file");
    DEFINE_string(delta_gd, "", "Delta GD file");
    DEFINE_string(tmp_file, "", "vertex v of graph G");
    ...
    DEFINE_double(sigma, 0.5, "sigma threshold for vertex matching");
    DEFINE_double(delta, 1.5, "delta threshold for path matching");
